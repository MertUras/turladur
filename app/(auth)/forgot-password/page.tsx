      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 sm:p-12 lg:p-16">
        <div className="w-full max-w-md">
              ...
              <div className="pt-1">
                ...
                >
                  {loading ? (
                    ...
                    <EnvelopeIcon
                      className="absolute left-3 h-5 w-5 text-blue-100 group-hover:text-white transition-colors duration-200"
                      aria-hidden="true"
                    />
                  )}
                  {loading
            ...
            <div className="mt-6 space-y-5 animate-fadeIn">
              ...
              <div className="text-center">
                <button
                  ...
                  className="inline-flex items-center py-2 px-3 text-xs font-medium text-neutral-950 hover:text-neutral-800 hover:underline underline-offset-2 transition-colors duration-200 focus:outline-none"
                >
          ...
          <div className="text-center pt-4 text-xs text-neutral-500 space-y-3">
            <Link
              href="/login"
              className="font-medium text-neutral-950 hover:text-neutral-800 hover:underline underline-offset-2 transition-colors duration-200 flex items-center justify-center"
            >
              <ArrowLeftIconSolid className="h-4 w-4 mr-1.5" />
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-gray-500">
              ...
              <Link
                href="/register"
                className="font-medium text-neutral-950 hover:text-neutral-800 hover:underline underline-offset-2 transition-colors duration-200"
              >
                Hemen kaydolun
              </Link>
            </p>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 p-10 text-center">
          <div className="max-w-md">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 tracking-normal">
              Şifrenizi Kolayca Sıfırlayın
            </h2>
            <p className="text-base text-neutral-200/90 mb-8 font-light">
