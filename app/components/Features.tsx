...
const featureData = [
  {
    ...
    title: 'Oteller',
    description:
      'Rezervasyon yönetimi, oda envanteri ve müşteri ilişkileri için kapsamlı çözümler',
    color: 'blue',
    features: [
      'Akıllı oda yönetimi',
    ...
    image:
      'https://images.unsplash.com/photo-1564501049412-61c2a3083791?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2064&q=80',
  },
  {
    id: 'tours',
    icon: (
    ...
    description:
      'Tur planlama, rota optimizasyonu ve grup yönetimi için akıllı araçlar',
    color: 'green',
    features: [
    ...
    cta: 'Turlarını Yönet',
    image:
      'https://images.unsplash.com/photo-1534777367038-9404f45b869a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
  },
  {
    id: 'agencies',
    icon: (
    ...
    title: 'Acenteler',
    description:
      'Satış yönetimi, komisyon takibi ve müşteri hizmetleri için entegre çözümler',
    color: 'purple',
    features: [
    ...
    image:
      'https://images.unsplash.com/photo-1556761175-129418cb2dfe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80',
  },
  {
    id: 'experiences',
    icon: (
    ...
    title: 'Deneyimler',
    description:
      'Yerel deneyimlerin keşfi, rezervasyonu ve yönetimi için yenilikçi platform',
    color: 'amber',
    features: [
      'Yerel deneyim keşfi',
      'Anlık rezervasyon',
...
export default function Features() {
  ...
  const getColorClass = (
    ...
    const prefix =
      element === 'bg' ? 'bg' : element === 'text' ? 'text' : 'border';
      ...
      <div className="container px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            Turizm ekosisteminin tüm bileşenlerini tek bir platformda
            buluşturuyoruz.
            ...
            >
              <span
                className={`transition-all duration-300 ${
                  hoveredFeature === feature.id && activeTab !== feature.id
                    ? 'scale-110'
                    : ''
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-10">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                <div
                  className={`w-16 h-16 ${getColorClass(activeFeature.color, true)} rounded-full flex items-center justify-center mb-4 shadow-lg`}
                >
                  {activeFeature.icon}
                </div>
            ...
            <div className="p-6 lg:p-10">
              <h3
                className={`text-2xl font-bold mb-6 ${getColorClass(activeFeature.color, false, 'text')}`}
              >
              ...
              <div className="space-y-5 mb-8">
                {activeFeature.features.map((feature, index) => (
                  ...
                  >
                    <div
                      className={`w-8 h-8 flex-shrink-0 ${getColorClass(activeFeature.color, false)} ${getColorClass(activeFeature.color, false, 'text')} rounded-full flex items-center justify-center`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
