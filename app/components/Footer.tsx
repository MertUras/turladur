            ...
            <div className="flex items-center mb-6">
              <Link href="/" className="flex items-center group">
                <div className="mr-2.5 flex-shrink-0">
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-200">
                    <Image src="/images/logo.png" alt="Turladur Logo" width={36} height={36} />
                  </div>
                </div>
                <span className="text-xl font-semibold text-white group-hover:text-neutral-100 transition-colors">Turladur</span>
              </Link>
            </div>
