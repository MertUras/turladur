...
const testimonials = [
  {
    ...
    content:
      "Tur operasyonlarımızı TourTech üzerinden yönetmeye başladıktan sonra müşteri memnuniyetimiz %95'e yükseldi ve satışlarımız iki katına çıktı! Çok memnunuz.",
  },
  {
    id: 2,
    name: 'Mehmet Demir',
  ...
  },
  {
    ...
    content:
      'TourTech ile yeni bir kitleye ulaştık. Rezervasyonlarımız %75 arttı ve platformun kullanımı çok kolay. Operasyonel yükümüz azaldı.',
  },
  {
    id: 4,
    name: 'Can Özkan',
    ...
    content:
      "Online satış kanalımız TourTech ile %60 büyüdü. Komisyon maliyetlerimizdeki %25'lik düşüş de cabası. Kesinlikle tavsiye ederim.",
  },
  {
    id: 5,
    name: 'Ahmet Yılmaz',
      ...
      <div className="container px-6 mx-auto max-w-7xl">
            ...
            {testimonials.map((testimonial) => (
              ...
              >
                <div className="bg-white border border-neutral-200/80 rounded-xl p-6 flex flex-col h-full shadow-sm transition-shadow duration-300 hover:shadow-md">
                  <p className="text-sm text-neutral-700 font-normal leading-relaxed mb-6 flex-grow italic before:content-['\201C'] before:mr-1 before:text-neutral-400 before:text-xl before:font-serif after:content-['\201D'] after:ml-1 after:text-neutral-400 after:text-xl after:font-serif">
                    {testimonial.content}
                  </p>
        ...
        <div className="mt-16 md:mt-20 text-center">
          <Link
            ...
            className="inline-flex items-center justify-center px-6 py-3 bg-white text-neutral-800 border border-neutral-300 hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-950 transition-colors font-medium rounded-lg shadow-sm text-sm"
          >
