        ...
        {reservations.length === 0 ? (
          ...
          <div key={reservation.id} className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${statusColors[reservation.status]}`}>
                {reservation.status}
              </div>
            </div>
            <div className="mt-4">
              <h4 className="text-sm font-medium text-gray-900">{reservation.activity}</h4>
              <p className="text-sm text-gray-500">{reservation.activityType}</p>
            </div>
