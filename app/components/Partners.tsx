      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            turta olarak sektörün önde gelen kurumlarıyla yaptığımız
            işbirlikleri sayesinde sizlere özel indirimler ve ayrıcalıklar
            sunuyoruz
          </p>
        </div>
        ...
        <div
          className={`mb-16 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-xl overflow-hidden transition-all duration-1000 delay-150 transform hover:scale-[1.02] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <div className="flex flex-col md:flex-row items-center relative">
            ...
            <div className="p-8 md:p-10 md:w-2/3 text-white relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                TÜRSAB İşbirliği Özel Kampanyası
              </h3>
              <p className="text-blue-100 mb-6">
                TÜRSAB üyesi acenteler aracılığıyla yapacağınız tüm
                rezervasyonlarda ekstra %15 indirim fırsatı! Üstelik ek
                hizmetlerde de özel avantajlar sizi bekliyor.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                >
                  ...
                  <ChevronRightIcon
                    className={`h-4 w-4 ml-2 transition-transform duration-300 ${isHoveredButton ? 'translate-x-1' : ''}`}
                  />
                </Link>
        ...
        >
          {filteredPartners.map((partner, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-6 flex items-center justify-between border-b border-gray-100 bg-gradient-to-r ${partner.color} group-hover:opacity-90`}
                >
          ...
          <div className="p-8 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl shadow-lg inline-block max-w-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                Kurumsal Müşterilerimize Özel
              </h3>
              <p className="text-gray-600 mb-6 max-w-lg mx-auto">
                Şirketiniz veya kurumunuz için özel indirimler ve avantajlardan
