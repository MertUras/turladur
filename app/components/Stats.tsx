      ...
      <div className="container px-6 mx-auto max-w-7xl">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div
                    className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${colors.bg}`}
                  >
        ...
        <div className="mt-16 md:mt-20 text-center">
          <p className="text-neutral-600 text-base mb-6 max-w-2xl mx-auto">
            Türkiye'nin dört bir yanındaki eşsiz destinasyonları ve aktiviteleri
            keşfedin. Özel fırsatlar ve unutulmaz deneyimler sizi bekliyor.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 mx-auto max-w-xs sm:max-w-none">
            <Link
              href="/tours"
              className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 bg-neutral-950 text-white hover:bg-neutral-800 rounded-lg transition-colors duration-200 font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-950 text-sm"
            >
              Turları Keşfet
