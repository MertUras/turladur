...
export default function Hero() {
  ...
  return (
    <section className="relative h-[700px] sm:h-[750px] w-full overflow-hidden">
      {/* Arka Plan Görselleri */}
        ...
        {backgroundImages.map((image, index) => (
          ...
          >
            <Image
              ...
              sizes="100vw"
              priority={index === 0}
              className="object-cover object-center transform scale-105 filter brightness-[0.85]" 
            />
          </div>
        ))}
      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-white">
        <div className="animate-fadeIn">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-center mb-4 tracking-tight leading-tight">
