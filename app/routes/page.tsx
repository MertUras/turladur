          ...
          <div className="bg-white rounded-xl shadow-xl p-4 sm:p-6">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-12 pr-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
