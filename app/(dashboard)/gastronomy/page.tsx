...
export default function GastronomiPage() {
    const experiences = [
        {
            id: 1,
            title: "Gaziantep Mutfak Turu",
            description: "UNESCO Gastronomi Şehri Gaziantep'in eşsiz lezzetlerini ve mutfak kültürünü keşfedin",
        ...
        },
        {
            ...
            description: "Hamsi, mısır ekmeği ve muhlama yapımını öğrenin, yerel şeflerle pişirin",
        ...
        },
        {
            ...
            description: "Zeytinyağı üretimini öğrenin, tadım yapın ve yerel üreticilerle tanışın",
        ...
        },
        {
            ...
            description: "Künefe, zahter, oruk gibi Hatay'ın meşhur sokak lezzetlerini tadın",
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative w-full h-[500px] mt-16">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-4">
                    <h1 className="text-5xl font-bold mb-4">Gastronomi Turları</h1>
                    <p className="text-xl max-w-3xl">
                        Türkiye'nin zengin mutfak kültürünü keşfedin. Yerel şeflerle tanışın, 
                        geleneksel tarifleri öğrenin ve eşsiz lezzetleri tadın.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-[85rem] mx-auto px-4 py-12 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-900">Öne Çıkan Gastronomi Turları</h2>
                    <p className="mt-2 text-sm text-gray-700">
                        En popüler ve beğenilen gastronomi rotalarımızı keşfedin.
                    </p>
                </div>
