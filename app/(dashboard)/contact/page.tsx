    ...
    <main className="bg-neutral-50 text-neutral-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 mb-6 !leading-tight">
                Sizinle İletişimde Olmaktan <span className="text-sky-600">Memnuniyet</span> Duyarız
              </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
                <div className="flex items-center p-5 bg-neutral-100/50 rounded-lg border border-neutral-200/80">
                  ...
                  <div>
                    <p className="text-xs text-neutral-500 font-medium uppercase tracking-wider">Müşteri Hizmetleri</p>
                    <p className="text-base font-semibold text-neutral-900">+90 850 123 45 67</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-5 bg-neutral-100/50 rounded-lg border border-neutral-200/80">
                  ...
                  <div>
                    <p className="text-xs text-neutral-500 font-medium uppercase tracking-wider">E-posta</p>
                    <p className="text-base font-semibold text-neutral-900">iletisim@tourtech.com</p>
                  </div>
                </div>
              </div>
      ...
      <div className="py-24 bg-neutral-100/70">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">İletişim Kanallarımız</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {[
              { icon: PhoneIcon, color: "sky", title: "Müşteri Hizmetleri", text: "7/24 müşteri hizmetleri ekibimiz her türlü sorunuz için yanınızda. Dilediğiniz zaman bizimle iletişime geçebilirsiniz.", phone: "+90 850 123 45 67", email: "destek@tourtech.com" },
              { icon: ClockIcon, color: "green", title: "Rezervasyon", text: "Rezervasyon yapmak, değişiklik veya iptal işlemleri için uzman ekibimizle iletişime geçebilirsiniz.", phone: "+90 850 123 45 68", email: "rezervasyon@tourtech.com" },
              { icon: UserGroupIcon, color: "purple", title: "İş Ortaklığı", text: "Otel, tur operatörü veya aktivite sağlayıcısı olarak TourTech ile iş birliği yapmak için bizimle iletişime geçin.", phone: "+90 850 123 45 69", email: "partner@tourtech.com" },
            ].map((card, index) => (
              <div key={index} className="bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300 border border-neutral-200/80 flex flex-col">
                <div className={`rounded-lg bg-${card.color}-100 p-3 inline-flex items-center justify-center w-12 h-12 mb-6`}>
                  <card.icon className={`w-6 h-6 text-${card.color}-600`} />
                </div>
                <h3 className="text-xl font-semibold text-neutral-900 mb-3">{card.title}</h3>
                <p className="text-neutral-600 mb-6 flex-grow text-sm leading-relaxed">{card.text}</p>
                <div className="space-y-3 pt-5 border-t border-neutral-100">
                  <div className="flex items-center text-sm">
                    <PhoneIcon className={`w-4 h-4 text-${card.color}-600 mr-3 flex-shrink-0`} />
                    <p className="font-medium text-neutral-800">{card.phone}</p>
                  </div>
                  <div className="flex items-center text-sm">
                    <EnvelopeIcon className={`w-4 h-4 text-${card.color}-600 mr-3 flex-shrink-0`} />
                    <p className="text-neutral-700 hover:text-neutral-900 transition-colors">{card.email}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div id="contactForm" className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">Bizimle İletişime Geçin</h2>
            <p className="text-lg text-neutral-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-neutral-50/80 rounded-xl p-8 border border-neutral-200/80">
                <h3 className="text-xl font-semibold text-neutral-900 mb-5 pb-4 border-b border-neutral-200">Genel Merkez</h3>
                <div className="space-y-4">
                  {[
                    { icon: MapPinIcon, text: "Levent Mah. Büyükdere Cad. No:201 Kat:5, 34394 Şişli/İstanbul" },
                    { icon: PhoneIcon, text: "+90 212 555 67 89" },
                    { icon: EnvelopeIcon, text: "info@tourtech.com" },
                    { icon: ClockIcon, text: "Pazartesi - Cuma: 09:00 - 18:00" },
                  ].map((item, index) => (
                    <div key={index} className="flex items-start">
                      <item.icon className="w-5 h-5 text-sky-600 flex-shrink-0 mt-0.5" />
                      <p className="ml-3 text-neutral-700 text-sm">{item.text}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <div id="offices" className="py-24 bg-neutral-50">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">Global Ağımız</h2>
            <p className="text-lg text-neutral-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {officeLocations.map((office, index) => (
              <div key={index} className="bg-white rounded-xl p-6 hover:shadow-lg transition-shadow duration-300 border border-neutral-200/80 flex flex-col">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <span className="text-xs text-sky-600 font-medium uppercase tracking-wider">TourTech</span>
                    <h3 className="text-lg font-semibold text-neutral-900 leading-tight">{office.city} Ofisi</h3>
                  </div>
                </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl p-8 md:p-10 border border-sky-100/70">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="max-w-lg">
                <h3 className="text-xl font-semibold text-neutral-900 mb-2">Kurumsal Ziyaretçiler İçin</h3>
                <p className="text-neutral-600 text-sm">
                  Kurumsal görüşmeler ve özel toplantılar için lütfen iletişim formumuz üzerinden önceden randevu talep ediniz.
                </p>
              </div>
              <a
                href="#contactForm"
      ...
      <div className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">Aklınızdaki Soruların Yanıtları</h2>
            <p className="text-lg text-neutral-600">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-3">
              {faqData.map((faq, index) => (
                <details key={index} className="group bg-white rounded-lg border border-neutral-200/80 overflow-hidden">
                  <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 hover:bg-neutral-50 transition-colors">
                    <span className="text-base font-semibold text-neutral-800">{faq.question}</span>
            ...
            <div className="mt-12 text-center border-t border-neutral-200 pt-8">
              <p className="text-neutral-600 mb-5 text-sm">Aradığınız sorunun cevabını bulamadınız mı?</p>
              <a
                href="#contactForm"
      ...
      <div className="py-20 bg-gradient-to-r from-sky-600 to-blue-700">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-5">Profesyonel Tatil Planlaması için TourTech</h3>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/" className="inline-block px-7 py-3 bg-white text-sky-700 font-medium rounded-lg transition-colors hover:bg-sky-50 shadow-sm text-sm">
                Tüm Seyahat Seçenekleri
              </Link>
              <Link href="/tours" className="inline-block px-7 py-3 bg-sky-700/50 text-white border border-sky-400/50 font-medium rounded-lg transition-colors hover:bg-sky-700 hover:border-sky-400 shadow-sm text-sm">
                Özel Turlar
              </Link>
            </div>
          </div>
