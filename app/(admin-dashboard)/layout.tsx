...
const sidebarLinks: SidebarLink[] = [
  ...
  { name: 'İstatistikler', href: '/admin-dashboard/statistics', icon: ChartBarIcon, description: 'İstatistikler ve raporlar' },
  { name: 'Ödemeler', href: '/admin-dashboard/payments', icon: CurrencyDollarIcon, description: 'Ödeme ve komisyon yönetimi' },
  { name: 'İçerik Yönetimi', href: '/admin-dashboard/content', icon: DocumentTextIcon, description: 'Blog ve sayfa yönetimi' },
  { name: 'Destek', href: '/admin-dashboard/support', icon: ChatBubbleLeftEllipsisIcon, description: 'Şikayet ve destek talepleri' },
  { name: 'Ayarlar', href: '/admin-dashboard/settings', icon: CogIcon, description: 'Sistem ayarları' },
];
            ...
            <div className="flex items-center p-3 bg-blue-50 rounded-lg">
              <div className="flex-shrink-0">
                <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-semibold">
                  {(session?.user?.name || 'Admin').split(' ').map(part => part[0]).join('').toUpperCase()}
                </div>
              </div>
              <div className="ml-3">
                      ...
                      <div className="py-2 px-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-xs text-gray-500">İstanbul Turu için yeni bir rezervasyon alındı.</p>
              ...
              <div className="relative ml-1" data-dropdown>
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50 origin-top-right">
                    ...
                    <div className="py-1">
                      <Link href="/admin-dashboard/settings" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        Profil ve Ayarlar
                      </Link>
                      <Link href="/admin-dashboard/help" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        Yardım ve Destek
                      </Link>
                    </div>
