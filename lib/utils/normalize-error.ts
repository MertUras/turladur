 ...
 */
export function normalizeError(value: unknown, fallbackMessage = 'Bir hata oluştu'): Error {
  if (value instanceof Error) {
    if (value instanceof SyntaxError) {
      return new Error('Sunucudan beklenmeyen bir yanıt alındı. Lütfen tekrar deneyin.');
    }
