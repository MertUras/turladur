...
const executiveTeam = [
  {
    ...
    bio: "Turizm ve teknoloji sektöründe 15+ yıllık liderlik deneyimine sahip olan Dr. Yılmaz, global turizm teknolojileri alanında uzmanlığını turta'in stratejik vizyonunu şekillendirmede kullanmaktadır.",
  },
  {
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl text-center mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-neutral-900 mb-6 !leading-tight">
              Turizmin Geleceğini
              <br />
              <span className="text-sky-600">Teknolojiyle</span>{' '}
              Şekillendiriyoruz
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <stat.icon
                  className={`w-7 h-7 mb-3 mx-auto text-${stat.color}-500`}
                />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-24 md:space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="lg:order-first">
              <p className="text-base font-semibold text-orange-500 uppercase tracking-wide mb-3">
                Misyonumuz
              </p>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tighter mb-6">
                Teknoloji ile{' '}
                <span className="text-orange-500">Seyahat Deneyimini</span>{' '}
                İyileştirmek
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              <p className="text-base font-semibold text-indigo-600 uppercase tracking-wide mb-3">
                Vizyonumuz
              </p>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tighter mb-6">
                Global Turizm Teknolojilerinde{' '}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {companyValues.map((value, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-xl border border-neutral-200/80 shadow-sm hover:shadow-md transition-shadow duration-300"
              >
                <div className="flex items-center mb-4">
                  {/* İkon stilini güncelle */}
                  <div
                    className={`w-10 h-10 rounded-lg bg-${value.color}-100 flex items-center justify-center mr-4`}
                  >
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="relative max-w-4xl mx-auto">
            {/* Dikey çizgi */}
            <div
              className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-neutral-200 hidden md:block"
              aria-hidden="true"
            ></div>
