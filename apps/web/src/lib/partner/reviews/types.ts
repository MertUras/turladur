...
export function resolveCategoryFeedback(
  ...
  for (const [ratingKey, feedbackKey] of Object.entries(
    CATEGORY_TO_FEEDBACK_KEY,
  ) as Array<[keyof PartnerReviewCategoryRatings, CategoryFeedbackKey]>) {
