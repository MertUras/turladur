...
- turladur.com çalışıyor
- api.turladur.com çalışıyor
```
...
| Adım | İşlem | Beklenen | Sonuç |
|------|-------|----------|-------|
| 1 | `https://turladur.com` | Ana sayfa, SSL aktif (yeşil kilit) | |
| 2 | `https://api.turladur.com/api/v1/health` | `{ status: "ok" }` | |
| 3 | `https://api.turladur.com/api/docs` | Swagger UI | |
